...
function [ rate ] = genIR( interval )
    date = datestr(datenum('01-Mar_2004')+round(interval*360)) ; 
    ...
    rate(1,1) = getParYields(NSModelUSD, date) ;
    rate(1,2) = getParYields(NSModelEUR, date) ; 
end
